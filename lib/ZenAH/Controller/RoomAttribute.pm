package ZenAH::Controller::RoomAttribute;
...
ZenAH::Controller::RoomAttribute - Scaffolding Controller Component
...
sub do_add : Local {
    my ( $self, $c ) = @_;
    $c->form( optional => [ ZenAH::Model::CDBI::RoomAttribute->columns ] );
