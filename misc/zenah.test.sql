...
INSERT INTO "device_control_link" VALUES(42, 9, 5);
INSERT INTO "device_control_link" VALUES(43, 9, 6);
INSERT INTO "device_control_link" VALUES(44, 10, 5);
INSERT INTO "device_control_link" VALUES(45, 10, 6);
INSERT INTO "device_control_link" VALUES(46, 11, 5);
INSERT INTO "device_control_link" VALUES(47, 11, 6);
...
INSERT INTO "map" VALUES(1, 'trigger_x10lamp', 'b1', 'l_bed_1');
INSERT INTO "map" VALUES(2, 'trigger_x10lamp', 'b2', 'l_bed_1_r');
INSERT INTO "map" VALUES(3, 'trigger_x10lamp', 'b3', 'l_bath');
...
INSERT INTO "room_attribute" VALUES(1, 'background_colour', '#66c866');
INSERT INTO "room_attribute" VALUES(2, 'background_colour', '#66c8c8');
INSERT INTO "room_attribute" VALUES(3, 'background_colour', '#c8c866');
INSERT INTO "room_attribute" VALUES(4, 'zone', 'upstairs');
INSERT INTO "room_attribute" VALUES(5, 'zone', 'downstairs');
INSERT INTO "room_attribute" VALUES(6, 'zone', 'outside');
CREATE TABLE "room_attribute_link" (
  "id" integer PRIMARY KEY,
  "room" int(11) default NULL,
  "room_attribute" int(11) default NULL
);
INSERT INTO "room_attribute_link" VALUES(1, 6, 1);
INSERT INTO "room_attribute_link" VALUES(2, 4, 2);
INSERT INTO "room_attribute_link" VALUES(3, 2, 3);
INSERT INTO "room_attribute_link" VALUES(4, 3, 3);
INSERT INTO "room_attribute_link" VALUES(5, 5, 3);
INSERT INTO "room_attribute_link" VALUES(6, 1, 3);
INSERT INTO "room_attribute_link" VALUES(7, 4, 4);
INSERT INTO "room_attribute_link" VALUES(8, 2, 4);
INSERT INTO "room_attribute_link" VALUES(9, 3, 5);
INSERT INTO "room_attribute_link" VALUES(10, 6, 6);
INSERT INTO "room_attribute_link" VALUES(11, 5, 5);
INSERT INTO "room_attribute_link" VALUES(12, 1, 5);
...
INSERT INTO "rule" VALUES(1, 'cuckoo', 'cron crontab="*/15 * * * *"', 'at', 'xpl -c osd.basic command=clear text="It is [% zenah.datetime.strftime("%H:%M") %]" delay=10
', 1, 1185300274, NULL);
INSERT INTO "rule" VALUES(2, 'trigger_x10lamp', 'message_type="xpl-trig" class="x10.basic" command=(on|off|bright|dim)', 'xpl', '[% SET lamp_name = zenah.map.x10lamp_trigger.lookup(xpl.device) %]
[% IF lamp_name %]
  ...
  [% END %]
[% END %]', 1, 1185300274, NULL);
INSERT INTO "rule" VALUES(3, 'trigger_x10app', 'message_type="xpl-trig" class="x10.basic" command=(on|off)', 'xpl', 'debug xpl_device = [% xpl.device %]
[% SET app_name = zenah.map.x10app_trigger.lookup(xpl.device) %]
...
INSERT INTO "template" VALUES(2, 'content/downstairs', '<table cellpadding="0" cellspacing="0" width="80%" border="1">
<tr>
...
[% IF r %]
  ...
  <div class="button"
    ><a href="[% base _ "/ui/?content=room&room=devices&room_name=" _ r.name %]"
  ...
  <tr>
    ...
    [% ELSE %]
      ...
      <td onclick="device_func([''args__[% device.name %]'',''args__[% control.name %]''],[''zenah_status'']);Effect.Pulsate(this);return false;">
        <div class="button"><a
          href="[% base _ "ui/action/" _ device.name _ "/" _ control.name %]"
...
<img id="logo" class="logo" height="50" width="50" src="/images/zenah-50.png" />
...
INSERT INTO "template" VALUES(17, 'html/buttonset', '[% FOR attribute = device.device_attributes %]
  ...
  <td onclick="device_func([''args__[% device.name %]'',''args__[% name %]''],[''zenah_status'']);Effect.Pulsate(this);return false;">
    <div class="button"><a
      href="[% base _ "ui/action/" _ device.name _ "/" _ name %]"
 ...
 <tabpanels>
   <tabpanel id="upstairs">
     <tabbox id="upstairsTabList">
       <tabs>
[% FOR room = ["bath" "bed_1" "bed_2" "bed_3" "bed_4" "ensuite" "landing"] %]
  [% SET r = table_class.search({ name => room }) %]
         <tab label="[% r.string %]" />
[% END %]
       </tabs>
...
[% END %]
   ...
   <tabpanel id="downstairs">
     <tabbox id="downstairsTabList">
       <tabs>
[% FOR room = ["cloak" "conservatory" "garage" "hall" "kitchen" "living" "node_0" "store" "study" "utility"] %]
  [% SET r = table_class.search({ name => room }) %]
         <tab label="[% r.string %]" />
[% END %]
       </tabs>
...
INSERT INTO "template" VALUES(22, 'config/main', '[% # config/main
   ...
   site = {
     ...
     logo      => ''/images/zenah-150.png'',
     copyright => ''2006, 2007 Mark Hindess'',
   };
...
-%]
', 1185028812);
INSERT INTO "template" VALUES(23, 'site/wrapper', '[% IF template.name.match(''.(css|js|txt)'');
...
[% MACRO navbutton(type, name) BLOCK %]
  ...
  <span class="navbutton[% cc %]"><a
    href="[% type.substr(0,1) == ''/'' ? Catalyst.uri_for("/", type) :
             Catalyst.uri_for("/", "ui", type) %]"
...
', 1185696008);
INSERT INTO "template" VALUES(36, 'error.tt2', '[% META title = ''Catalyst/TT Error'' %]
<p>
...
', 1185630505);
INSERT INTO "template" VALUES(37, 'site/roomstyle.css', '[% USE table_class = Class(''ZenAH::Model::CDBI::Room'') %]
[% FOREACH room = table_class.retrieve_all %]
  [% SET bg = room.attribute("background_colour") || "white" %]
  [% SET fg = room.attribute("foreground_colour") || "black" %]
  [% SET n = room.name %]
  .roomtable[% n %], .roomtable[% n %] TD, .roomtable[% n %] TH
  {
    background-color: [% bg %];
    color: [% fg %];
  }
