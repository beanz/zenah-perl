...
INSERT INTO "rule" VALUES(1,'cuckoo','recurrence freq=hourly minutes="[0,15,30,45]"','at','xpl -m xpl-cmnd -c osd.basic command=clear text="It is [% zenah.datetime.strftime("%H:%M") %]" delay=10
...
[% END %]
',1,1186334285,2007);
INSERT INTO "rule" VALUES(8,'kettle_warn','30','at','xpl -m xpl-cmnd -c osd.basic command=clear row=3 text="Kettle is on" delay=5
',0,1186322063,NULL);
...
<html>
 <head>
  ...
  <script type="text/javascript"
          src="http://ajax.googleapis.com/ajax/libs/dojo/1.1.1/dojo/dojo.xd.js"
